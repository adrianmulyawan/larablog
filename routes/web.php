...
Route::get('/dashboard/organization', [OrganizationController::class, 'index'])->name('organization.index');
Route::get('/dashboard/organization/add', [OrganizationController::class, 'create'])->name('organization.create');
Route::post('/dashboard/organization/store', [OrganizationController::class, 'store'])->name('organization.store');
Route::get('/dashboard/organization/edit/{id}', [OrganizationController::class, 'edit'])->name('organization.edit');
Route::put('/dashboard/organization/update/{id}', [OrganizationController::class, 'update'])->name('organization.update');

Route::get('/dashboard/action', [ActionController::class, 'index'])->name('action.index');
Route::get('/dashboard/action/add', [ActionController::class, 'create'])->name('action.create');
Route::post('/dashboard/action/store', [ActionController::class, 'store'])->name('action.store');
Route::get('/dashboard/action/edit/{id}', [ActionController::class, 'edit'])->name('action.edit');
Route::put('/dashboard/action/update/{id}', [ActionController::class, 'update'])->name('action.update');
Route::delete('/dashboard/acrion/delete/{id}', [ActionController::class, 'destroy'])->name('action.destroy');

Route::get('/dashboard/focus', [FocusController::class, 'index'])->name('focus.index');
Route::get('/dashboard/focus/add', [FocusController::class, 'create'])->name('focus.create');
Route::post('/dashboard/focus/store', [FocusController::class, 'store'])->name('focus.store');
Route::get('/dashboard/focus/edit/{id}', [FocusController::class, 'edit'])->name('focus.edit');
Route::put('/dashboard/focus/update/{id}', [FocusController::class, 'update'])->name('focus.update');
Route::delete('/dashboard/focus/delete/{id}', [FocusController::class, 'destory'])->name('focus.destory');
