    ...
    <main>
        <div class="container-fluid px-4">
            ...
            <ol class="breadcrumb mb-4">
                <li class="breadcrumb-item active text-capitalize">Edit Fokus LSM Kompas</li>
            </ol>
                    ...
                    <div class="card card-table">
                        <div class="card-header">
                            <div class="d-flex justify-content-between align-items-center py-2">
                                <h5 class="text-start my-2 mx-2">Form Edit Data Fokus</h5>
                            </div>
                        </div>
                        <div class="card-body">
                            <form action="{{ route('focus.update', $target->id) }}" method="post">
                                @csrf
                                @method('PUT')
                                <div class="mb-4">
                                    ...
                                    <input type="text" class="form-control" id="target_name" name="target_name"
                                        value="{{ old('target_name', $target->target_name) }}"
                                        placeholder="Masukan Nama Fokus">
                                    @error('target_name')
                                ...
                                <div class="mb-4">
                                    ...
                                    <input type="text" class="form-control" id="target_description"
                                        ...
                                        value="{{ old('target_description', $target->target_description) }}"
