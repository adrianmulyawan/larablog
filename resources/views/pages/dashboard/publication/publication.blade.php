    ...
    <main>
        <div class="container-fluid px-4">
            ...
            <ol class="breadcrumb mb-4">
                <li class="breadcrumb-item active text-capitalize">Kelola Publikasi</li>
            </ol>
                    ...
                    <div class="card card-table">
                        <div class="card-header">
                            <div class="d-flex justify-content-between align-items-center py-2">
                                <h5 class="text-start my-2 mx-2">Daftar Publikasi</h5>
                                <a href="{{ route('publication.create') }}" class="btn btn-add text-end mx-2 px-3">
                            ...
                            <table class="table table-responsive table-bordered">
                                <thead>
                                    <tr>
                                        ...
                                        <th scope="col" class="text-center table-heading">Judul Publikasi</th>
                                    ...
                                    @forelse ($items as $item)
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                {{ Str::limit($item->publication_name, 30, '...') }}
                                            </td>
                                            <td class="text-center">
                                                {{ $item->publicationCategory->publication_category_name }}
                                            </td>
                                            <td class="text-center">
                                                {{ $item->publication_uploader }}
                                            </td>
                                            <td class="text-center">
                                                {{ $item->publication_author }}
                                            </td>
                                            <td class="text-center">
                                                ...
                                                <a href="{{ route('publication.destroy', $item->id) }}"
