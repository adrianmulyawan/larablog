    ...
    <main>
        <div class="container-fluid px-4">
            ...
            <ol class="breadcrumb mb-4">
                <li class="breadcrumb-item active text-capitalize">Tambah Kategori Publikasi</li>
            </ol>
                    ...
                    <div class="card card-table">
                        <div class="card-header">
                            <div class="d-flex justify-content-between align-items-center py-2">
                                <h5 class="text-start my-2 mx-2">Form Tambah Data Kategori</h5>
                            </div>
                        </div>
                        <div class="card-body">
                            <form action="{{ route('publication.category.store') }}" method="post">
                                @csrf
                                <div class="mb-4">
                                    ...
                                    <input type="text" class="form-control" id="publication_category_name"
                                        name="publication_category_name" value="{{ old('publication_category_name') }}"
