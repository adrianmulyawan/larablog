...
@section('title', 'LSM KOMPAS - Edit Berita')
    ...
    <main>
        <div class="container-fluid px-4">
            ...
            <ol class="breadcrumb mb-4">
                <li class="breadcrumb-item active text-capitalize">Edit Data Berita</li>
            </ol>
                    ...
                    <div class="card card-table">
                        <div class="card-header">
                            <div class="d-flex justify-content-between align-items-center py-2">
                                <h5 class="text-start my-2 mx-2">Form Edit Data Berita</h5>
                            </div>
                        </div>
                        <div class="card-body">
                            <form action="{{ route('news.update', $news->id) }}" method="post"
                                ...
                                <div class="mb-4">
                                    ...
                                    <input type="text" class="form-control" id="news_name" name="news_name"
                                        value="{{ old('news_name', $news->news_name) }}" placeholder="Masukan Judul Berita">
                                    @error('news_name')
                                ...
                                <div class="mb-4">
                                    ...
                                    <select class="form-select" id="news_category_id" name="news_category_id">
                                        <option value="{{ $news->news_category_id }}" selected disabled>
                                            {{ $news->newsCategory->news_category_name }} (Kategori Berita Sekarang)
                                        </option>
                                ...
                                <div class="mb-4">
                                    ...
                                    <input type="text" class="form-control" id="news_image_source"
                                        name="news_image_source"
                                        value="{{ old('news_image_source', $news->news_image_source) }}"
                                ...
                                <div class="mb-4">
                                    ...
                                    <textarea class="form-control" id="news_body" name="news_body" rows="10" placeholder="Isi Berita">{{ old('news_body', $news->news_body) }}</textarea>
                                    @error('news_body')
                                        <div class="form-text text-danger">
                                            {{ $message }}
                                        </div>
                                ...
                                <div class="mb-4">
                                    ...
                                    <input type="text" class="form-control" id="news_author" name="news_author"
                                        value="{{ old('news_author', $news->news_author) }}"
