...
@section('title', 'LSM KOMPAS - Edit Info Organisasi')
    ...
    <main>
        <div class="container-fluid px-4">
            ...
            <ol class="breadcrumb mb-4">
                <li class="breadcrumb-item active text-capitalize">Edit Info Mengenai Organisasi</li>
            </ol>
                    ...
                    <div class="card card-table">
                        <div class="card-header">
                            <div class="d-flex justify-content-between align-items-center py-2">
                                <h5 class="text-start my-2 mx-2">Form Edit Data Info Organisasi</h5>
                            </div>
                        </div>
                        <div class="card-body">
                            <form action="{{ route('organization.update', $data->id) }}" method="post"
                                ...
                                <div class="mb-4">
                                    ...
                                    <input type="text" class="form-control" id="organization_name"
                                        ...
                                        value="{{ old('organization_name', $data->organization_name) }}"
                                ...
                                <div class="mb-4">
                                    ...
                                    <textarea class="form-control" id="organization_description" name="organization_description"
                                        placeholder="Masukan Deskripsi Organisasi" rows="3">{{ old('organization_description', $data->organization_description) }}</textarea>
                                ...
                                <div class="mb-4">
                                    ...
                                    <input type="text" class="form-control" id="organization_motto"
                                        ...
                                        value="{{ old('organization_motto', $data->organization_motto) }}"
                                ...
                                <div class="mb-4">
                                    ...
                                    @enderror
                                    <small class="text-muted">Logo Lama</small> <br>
                                ...
                                <div class="mb-4">
                                    ...
                                    <input type="text" class="form-control" id="organization_contact"
                                        ...
                                        value="{{ old('organization_contact', $data->organization_contact) }}"
                                ...
                                <div class="mb-4">
                                    ...
                                    <input type="text" class="form-control" id="organization_address"
                                        ...
                                        value="{{ old('organization_address', $data->organization_address) }}"
